...
namespace Spaceinvaders
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (spaceship1.Intersects(spaceblock3) || spaceship1.Intersects(spaceblock3))
                spaceship1.X = spaceblock3.X - 20;
            if (pew1.Y < 0 || pew1.Y > Window.ClientBounds.Height - pew1.Height)
                pew1.Y = 245;
            if (pew2.Y < 0 || pew2.Y > Window.ClientBounds.Height - pew2.Height)
                pew2.Y = 245;
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (kstate.IsKeyDown(Keys.Space))
            {
                while (tid > 0)
                {
                    spriteBatch.Draw(pixel, pew1, Color.Blue);
                    spriteBatch.Draw(pixel, pew2, Color.Blue);
